 ...
 */
import { CRAFT_RECIPES, EQUIPMENT, MATERIALS } from "./data";
import type { CharacterId, DailyMissionState, DynamicEventState, EquipmentSetProgress, EquipmentSlot, NarrativeStage } from "./types";
...
export class UIController {
    ...
    this.root.innerHTML = `
      <section class="rpg-title-screen" id="title-screen">
        ...
        <div class="title-content">
          ...
          <p class="control-note">WASD mover · Mouse câmera · Q / E magia · I inventário · F interagir · F1 debug</p>
        </div>
      </section>
  ...
  dispose() { this.partyReactionTimers.forEach((timer) => window.clearTimeout(timer)); this.root.remove(); }
}
