    ...
    this.root.innerHTML = `
      <section class="rpg-title-screen" id="title-screen">
        ...
        <div class="title-content">
          ...
          <p class="control-note">WASD mover · Mouse câmera · Q / E magia · 5 / 6 / 7 cinto · I inventário · F interagir · F1 debug</p>
        </div>
      </section>
      <section class="rpg-hud" id="rpg-hud" aria-live="polite">
        ...
        <div class="skills-panel"><span><b>Q</b><i id="skill-q">Centelha</i></span><span><b>E</b><i id="skill-e">Impulso</i></span><span class="locked"><b>R</b><i>Selada</i></span></div><div class="quick-belt" id="quick-belt" aria-label="Cinto rápido de consumíveis"></div>
