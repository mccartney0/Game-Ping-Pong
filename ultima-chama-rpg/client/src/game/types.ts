...
export interface SaveData {
  ...
  settings: { difficulty: "Historia" | "Aventura" | "Veterano" | "Lendario"; reducedMotion: boolean; language: "pt-BR" | "en"; narrationEnabled: boolean; dialogueSubtitlesEnabled: boolean; actionSubtitlesEnabled: boolean; voiceVolume: number; sfxVolume: number; musicVolume: number };
  savedAt: number;
}
